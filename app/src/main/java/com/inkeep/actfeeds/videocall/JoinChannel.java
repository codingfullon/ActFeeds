package com.inkeep.actfeeds.videocall;
...
public class JoinChannel extends AppCompatActivity {
    ...
    private static final String LOG_TAG = JoinChannel.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intent!=null) {
            String  channel = intent.getStringExtra("TitleName");
            channelName.setText("You have joined "+channel+" Channel");
        }
    ...
    private void setupRemoteVideo(int uid) {
        ...
        View tipMsg = findViewById(R.id.channel_name); // optional UI
