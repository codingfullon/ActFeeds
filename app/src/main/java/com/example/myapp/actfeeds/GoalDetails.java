...
import com.example.myapp.actfeeds.utilities.ItemAttributes;
import com.example.myapp.actfeeds.utilities.ListViewCustomAdapter;
...
import static com.example.myapp.actfeeds.data.HabitContract.*;
    ...
    public void showAlert(){
        ...
        for (int i = 0; i < 7; i++) {
            if(checkBoxRepeat.isChecked()) {
                weeks[i]=weekDaysAdapter.itemList.get(i).itemName+" ";
            }else if(weekDaysAdapter.itemList.get(i).aBoolean) {
                weeks[i] = weekDaysAdapter.itemList.get(i).itemName+" ";
            }else{weeks[i]="";}
        }
        ...
        AlertDialog alertDialog = new AlertDialog.Builder(contextThemeWrapper)
                .setTitle("Save this activity")
                .setMessage("Name: "+title+"\nTime: "+reminderTime+"\n"+"Duration: "+mHours+"h "+mMins+"m\n"+
                      "Start Date: "+textStartDate+"\nEnd Date: "+textEndDate+"\nRepeat On: "+weeks[0]+""+weeks[1]+""+
                ...
                .setPositiveButton("YES", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int i) {
                          // finish();
                            dialog.dismiss();
                            saveData();
                            Toast.makeText(getBaseContext(), "Activity saved successfully",Toast.LENGTH_LONG).show();
                            Intent intent = new Intent(GoalDetails.this, MainActivity.class);
                            startActivity(intent);
                        }
                }).create();
